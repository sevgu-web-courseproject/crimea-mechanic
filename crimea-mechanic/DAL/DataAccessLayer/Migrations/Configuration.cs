...
namespace DataAccessLayer.Migrations
{
    internal sealed class Configuration : DbMigrationsConfiguration<DatabaseContext>
    {
        ...
        protected override void Seed(DatabaseContext context)
        {
            ...
            CheckAndCreateWorkClassWithWorkTypes(context, "Ремонт двигателя", "Диагностика", "Полная переборка двигателя", "Замена опор двигателя (подушек)", "Замена прокладки поддона картера", "Замена прокладки клапанной крышки", "Замена роликов и ремня ГРМ", "Регулировка клапанов", "Замена масляного насоса");
