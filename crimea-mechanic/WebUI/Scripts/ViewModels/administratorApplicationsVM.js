var administratorApplicationsVM = new function() {
    ...
    var getApplications = function () {
        ...
        var url = window.resource.urls.webApiGetInfosForAdministratorUrl;
    ...
    var saveFilter = function(application) {
        ...
        localStorage.administratorApplications = data;
        window.location.href = window.resource.urls.webUiApplicationCard + '/' + application.Id;
    }

    var init = function() {
        if (localStorage.administratorApplications) {
            ko.mapping.fromJSON(localStorage.administratorApplications, {}, filter);
            localStorage.removeItem("administratorApplications");
        }
